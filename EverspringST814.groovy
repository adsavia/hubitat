 ...
 *
 *
 *	2018-10-19	erktrek	ported driver over from SmartThings to Hubitat Elevation.
 *
 *
 *
 */
...
preferences {
	...
	simulator 
	{
		...
		for( int i = 0; i <= 100; i += 20 ) 
		{
			status "humidity ${i}%": new hubitat.zwave.Zwave().sensorMultilevelV2.sensorMultilevelReport(
